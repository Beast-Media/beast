...
export class Init1707532049414 implements MigrationInterface {
  name = 'Init1707532049414';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_season_entity" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "season_number" integer NOT NULL, "overview" text, "images" text NOT NULL, "showId" varchar NOT NULL, CONSTRAINT "unique_season_for_show" UNIQUE ("season_number", "showId"), CONSTRAINT "FK_318db52547fdccb165224ccfc86" FOREIGN KEY ("showId") REFERENCES "show_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_episode_entity" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "episode_number" integer NOT NULL, "overview" text, "images" text NOT NULL, "mediaId" varchar NOT NULL, "seasonId" varchar NOT NULL, CONSTRAINT "REL_20a184ec67f9c2811477bc5a0f" UNIQUE ("mediaId"), CONSTRAINT "FK_20a184ec67f9c2811477bc5a0f1" FOREIGN KEY ("mediaId") REFERENCES "media_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_7a6dbe6fc6b24c4efb2c7914e53" FOREIGN KEY ("seasonId") REFERENCES "season_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_media_stream_entity" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "streamIndex" integer NOT NULL, "type" varchar NOT NULL, "mediaId" varchar NOT NULL, CONSTRAINT "FK_ec846b4060558ca10f018801815" FOREIGN KEY ("mediaId") REFERENCES "media_entity" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
